...
<div id="container">
    ...
    <div class="ct">
        <div class="ct_wrap">
            <div class="top_title">
                <a href="/reservation/detail?id=${displayInfoId}" class="btn_back" title="이전 화면으로 이동"> <i
                ...
                <div class="container_visual" style="width: 414px;">
                    <ul class="visual_img">
                        <li class="item" style="width: 414px;"><img alt="" class="img_thumb"
                                                                    src="/reservation/${displayInfoResponse[0].saveFileName}">
            ...
            <div class="section_booking_form">
                <div class="booking_form_wrap">
                    <div class="form_wrap">
                        ...
                        <div class="agreement_nessasary help_txt"><span class="spr_book ico_nessasary"></span>
                            <span>필수입력</span></div>
                        <form action="/reservation/reservations" method="post" class="form_horizontal" id="reservationParam">
                            ...
                            <div class="inline_form"><label class="label" for="name"> <span
                                ...
                                <div class="inline_control name_wrap">
                                    ...
                                    <div class="warning_msg">올바른 형식이 아닙니다.</div>
                                </div>
                            </div>
                            ...
                            <div class="inline_form last"><label class="label" id="message" for="message">예매내용</label>
                ...
                <div class="section_booking_agreement">
                    <div class="agreement all"><input type="checkbox" id="chk3" class="chk_agree"> <label for="chk3"
                                                                                                          class="label chk_txt_label">
            ...
            <div class="box_bk_btn">
                ...
                <div class="bk_btn_wrap disable">
                    <button type="button" class="bk_btn"><i class="spr_book ico_naver_s"></i> <span>예약하기</span>
                    </button>
                </div>
            </div>
        </div>
...
<script type="rv-template" id="ticketTypeForm">
    <div class="qty">
        <div class="count_control">
            <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
            <div class="clearfix" id="{{productPriceId}}">
        ...
        <div class="qty_info_icon">
            ...
            <em class="product_dsc">{{priceChar}} ({{discountRate}}% 할인가)</em>
        </div>
    </div>
</script>
<%--<script type="rv-template" id="hiddenForm">--%>
    <%--<div class="inline_form">--%>
        <%--<div class="inline_control">--%>
            <%--<input type="hidden" name="prices" value="{{stringProductPrice}}">--%>
        <%--</div>--%>
    <%--</div>--%>
<%--</script>--%>

<script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.1.2/handlebars.min.js"></script>
<script src="/reservation/js/reservationParam.js"></script>
<script src="/reservation/js/hiddenForm.js"></script>
<script src="/reservation/js/reservationAgree.js"></script>
<script src="/reservation/js/reservationUser.js"></script>
<script src="/reservation/js/ticketTemplate.js"></script>
<script src="/reservation/js/ticketInfo.js"></script>
