    ...
    <div class="ct">
        <div class="ct_wrap">
            <div class="top_title review_header">
                <a href="/reservation/booking/list?reservationEmail=${reservationEmail}" class="btn_back"
                   title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                <h2><span class="title">${reservationInfo.displayInfo.productDescription}</span></h2>
            </div>
            <!-- 리뷰 별점 -->
            <div class="write_act">
            ...
            <div class="review_contents write">
                ...
                <textarea name="comment" cols="30" rows="10" class="review_textarea"></textarea>
            </div>
            <!-- //리뷰 입력 -->
            <!-- 리뷰 작성 푸터 -->
            <div class="review_write_footer_wrap">
                <div class="review_write_footer">
                    ...
                    <input type="file" class="hidden_input" name="reviewImg"
            ...
            <!--hidden type-->
            <input type="hidden" name="reservationInfoId" value="${reservationInfo.reservationInfoId}">
            <input type="hidden" name="productId" value="${reservationInfo.productId}">
            <!-- 리뷰 등록 -->
...
<script src="/reservation/js/review/review.js"></script>
<script src="/reservation/js/review/ratingScore.js"></script>
<script src="/reservation/js/review/textArea.js"></script>
<script src="/reservation/js/review/fileUpload.js"></script>
