...
<app>
    <toast-alert class="top_info hide booking_alert">
        ...
        <a href="./mainpage.html" class="top_info_close" data-tst_alt_close="0"> <i class="fn fn-close"
                ...
                class="sr_only" translate="CM-CLOSE">닫기</span> </a>
    </toast-alert>
    <!---->
    <div class="_view_content" ui-view="content" id="container">
        <booked-confirm>
            <div class="booking_login">
                <h1 class="login_header"><a href="/reservation/mainpage" class="nbooking_logo spr_bi txt_logo"> <span
                        translate="CM-NBOOKING">네이버 예약</span> </a></h1>
                <!---->
                <div>
                    <form name="confirm_form" class="ng-pristine ng-valid" id="form1"
                          action="/reservation/booking/list">
                        <h2 class="login_header_sub border_bottom"><span translate="CM-NON_MEMBER_BK_CONFIRMATION">비회원 예약확인</span>
                        </h2>
                        ...
                        <button type="button" form="form1" class="login_btn confirm"><span
    ...
    <footer aria-hidden="false">
        <!---->
        <go-to-top>
            <div class="gototop" aria-hidden="false"><a href="https://m.booking.naver.com/#" class="lnk_top"> <span
                    class="lnk_top_text" translate="CM-TOP">TOP</span> </a></div>
        </go-to-top>
        <!----> <!---->
        <div id="footer" class="footer">
            ...
            <ul class="lst_link">
                ...
                <li class="item"><a class="anchor"
                    ...
                    <strong class="policy_em" translate="CM-PRIVACY_POLICY">개인정보처리방침</strong> </a></li>
...
<script src="/reservation/js/emailLogin.js"></script>
<script src="/reservation/js/redirectPage.js"></script>
</body>
</html>